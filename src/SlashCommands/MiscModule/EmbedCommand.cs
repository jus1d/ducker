...
public partial class MiscSlashCommands
{
    ...
    public async Task EmbedCommand(InteractionContext msg,
        [Option("description", "Set description tp your embed")]
        string description = "",
        [Option("title", "Set title for your embed")]
        string title = "",
        [Option("color", "Set color to your embed")]
        string colorHexCode = "9b73ff",
        [Option("image", "Add image to your embed")]
        string imageUrl = "",
        [Option("titleURL", "Set title clickable to your URL")]
        string titleUrl = "")
    {
