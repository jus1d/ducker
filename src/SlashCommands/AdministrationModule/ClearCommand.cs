...
public partial class AdministrationSlashCommands
{
    ...
    [RequireAdmin]
    public async Task ClearCommand(InteractionContext msg,
        [Option("amount", "Amount messages to delete")]
        long amount)
    {
        ...
        else
        {
            ...
            await Log.Audit(msg.Guild,
                $"{msg.Member.Mention} cleared {amount} {messageOrMessages} in {msg.Channel.Mention}");
