...
namespace ducker.SlashCommands.AdministrationModule
{
    public partial class AdministrationSlashCommands
    {
        ...
        public async Task Ban(InteractionContext msg, [Option("user", "User for ban")] DiscordMember member, [Option("reason", "Reason for ban this user")] string reason = "No reason given")
        {
