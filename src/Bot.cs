...
public class Bot
{
    ...
    public static readonly string InviteLink =
        "https://discord.com/api/oauth2/authorize?client_id=921896450915434537&permissions=8&scope=bot%20applications.commands";
    ...
    public DiscordClient Client { get; } = new(new DiscordConfiguration
    {
